...
sfdx force:package1:version:create -u ltngSharePkg --packageid 03346000000L5gS -n "Spring19" -r "https://salesforce.quip.com/AJeQA2j2bMw5" -p "https://salesforce.quip.com/AJeQA2j2bMw5" -m -w 60 -d "spring19, built on LWC. Lots of fixes"
