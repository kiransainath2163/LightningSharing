...
sfdx force:package1:version:create -u ltngSharingPkg --packageid 03346000000L5gS -n "Winter20" -r "https://salesforce.quip.com/AJeQA2j2bMw5" -p "https://salesforce.quip.com/AJeQA2j2bMw5" -m -w 60 -d "update apex for global describe to support newer objects "
