...
sfdx force:package1:version:create -u ltngSharePkg --packageid 03346000000L5gS -n "Summer18" -r "https://salesforce.quip.com/AJeQA2j2bMw5" --publishwait "https://salesforce.quip.com/AJeQA2j2bMw5" -m -w 60 -d "summer 18 release with new navigation, community support"
